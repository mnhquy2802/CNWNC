        ...
        if (user === null) {
            ...
            return (
                <ul>
                    ...
                    <div class="dropdown" >
                        <button className="site-button-link">{user.data.username}</button>
                        <div class="dropdown-content">
                            <button onClick = {() => {Profiler();}}>profile</button>
                            ...
                            <ul className="nav navbar-nav">
                                <li><Link to={'./'}>Home <i class="fa fa-chevron-down"></i></Link>
                                    <ul class="sub-menu">
                                        ...
                                        <li><Link to={'./'} class="dez-page">Home 2 <span class="new-page menu-new">New</span></Link></li>
                                    </ul>
                                </li>
